...
class BusinessThisApp:
                        ...
                        if email and password:
                            with st.spinner("Authenticating..."):
                                ...
                                if status == 200:
                                    ...
                                    st.error(f"❌ {response.get('error', 'Login failed')}")
                        else:
                        ...
                        if email and password and password == confirm_password:
                            with st.spinner("Creating your account..."):
                                ...
                                if status == 201:
                                    ...
                                    st.error(f"❌ {response.get('error', 'Registration failed')}")
                        else:
                            st.error("⚠️ Please fill in all fields and ensure passwords match")
    ...
    def dashboard(self):
        ...
        with st.sidebar:
            ...
            nav_items = [
                ("🏠", "Dashboard", "dashboard", "Overview of your financial status"),
                ("💰", "Financial Profile", "profile", "Manage your financial information"),
                ("🎯", "Savings Goals", "goals", "Track and manage your savings goals"),
                ("📊", "Calculator", "calculator", "Financial planning calculators"),
                ("📈", "Analytics", "analytics", "Detailed financial analytics"),
